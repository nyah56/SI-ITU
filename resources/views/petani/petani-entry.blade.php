...
<div class="container-md bg-white p-5 mt-4 shadow-sm">
    <h1 class="h3 mb-3 text-gray-800">Tambah data Petani</h1>
    <form action="{{ url('/petani/store') }}" method="post">
        @csrf
        <div class="form-group">
            <label for="exampleInputEmail1">ID Petani</label>
            <input type="text" name="id_petani" class="form-control" id="">

        </div>
        <div class="form-group">
            <label for="exampleInputEmail1">Nama Petani</label>
            <input type="text" name="nama_petani" class="form-control" id="">
        </div>
        <div class="form-group">
