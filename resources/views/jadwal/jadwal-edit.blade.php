...
<div class="container-md bg-white p-5 mt-4 shadow-sm">
    <h1 class="h3 mb-3 text-gray-800">Ubah data Jadwal</h1>
    <form action="{{ url('/jadwal/update/'.$jadwal->id_jadwal ) }}" method="post">
        @csrf
        @method('put')
        <div class="form-group">
            <label for="exampleInputEmail1">ID Jadwal</label>
            <input type="text" name="id_jadwal" value="{{ $jadwal->id_jadwal }}" class="form-control" id="disabledInput" disabled>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" name="kirim_hari" value="{{ $jadwal->kirim_hari }}" class="form-control" id="">
        </div>
        <div class="form-group">
            <label for="exampleInputEmail1">Jumlah</label>
            <input type="text" name="jumlah"value="{{ $jadwal->jumlah }}"  class="form-control" id="">
        </div>
        <div class="form-group">
            <label for="exampleInputEmail1">Alamat</label>
            <input type="text" name="alamat" value="{{ $jadwal->alamat }}"  class="form-control" id="">
        </div>
