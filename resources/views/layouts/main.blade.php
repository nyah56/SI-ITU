...
<head>
    ...
    <title>Supplier Bahan Makanan ITU</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/dashboard">
                ...
                <div class="sidebar-brand-text mx-3">Supplier Itu</div>
            </a>
            ...
            <li class="nav-item {{ ($title==="jadwal") ? 'active' :'' }}">
                <a class="nav-link" href="/jadwal">
                    ...
                    <span>Jadwal Pemesanan</span></a>
            </li>
            <li class="nav-item {{ ($title==="konsumen") ? 'active' :'' }}">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Ibnu 2022</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Pilih "Logout" untuk meninggalkan halaman.</div>
